...
void village_card (int currentPlayer,struct gameState *state, int handPos){
   //+1 Card
	...
	// changed the +2 Actions to +3 Actions
...
// refactored/bugs added cards
void minion_card(struct gameState *state, int handPos, int currentPlayer, int choice1, int choice2){
...
//  int cardDrawn;
  ...
  switch( card ) 
    ...
    case feast:
      feast_card(state, currentPlayer, temphand, choice1);      			
      return 0;
