...
/* Description: Puts random yet somewhat reasonable gibberish in the passed gameState
 * Source: OSU CS362 Lecture 11: Random Testing 1
 */
int randomizeGameState(struct gameState* cur, int seed);

/* Description: prints out gameState info in a semi-readable manner
 */
void printGameState(struct gameState* cur);

/* Description: Used to test adventurer. Counts all treasures in the hand and returns that number
 */
